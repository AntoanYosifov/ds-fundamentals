...
import tree.implementations.TreeFactory;
...
public class TreeAdvancedTest {
    ...
    public void testTreeCreation() {
        ...
        TreeAdvanced<Integer> tree = treeFactory.createTreeFromStrings(input);
    ...
    public void testDeepestLeftmostNode() {
        ...
        TreeAdvanced<Integer> deepestLeftmostNode = tree.getDeepestLeftmostNode();
    ...
    public void testTreesWithGivenSum() {
        ...
        TreeFactory treeFactory = new TreeFactory();
        TreeAdvanced<Integer> tree = treeFactory.createTreeFromStrings(input);
        List<TreeAdvanced<Integer>> trees = tree.subTreesWithGivenSum(43);
